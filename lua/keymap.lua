...
-- Window Commands
vim.keymap.set({ "n", "x", "t" }, "<A-h>", "<C-w><C-h>", { desc = "Move focus to the left window" })
vim.keymap.set({ "n", "x", "t" }, "<A-l>", "<C-w><C-l>", { desc = "Move focus to the right window" })
vim.keymap.set({ "n", "x", "t" }, "<A-j>", "<C-w><C-j>", { desc = "Move focus to the lower window" })
vim.keymap.set({ "n", "x", "t" }, "<A-k>", "<C-w><C-k>", { desc = "Move focus to the upper window" })
